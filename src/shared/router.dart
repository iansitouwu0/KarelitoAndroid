...
import '../features/estadisticas/view/estadisticas_screen.dart';
...
String? _levelIdFromPath(String path) {
  const map = {
    ...
    '/levelView/nivel_3': 'nivel_3',
    '/levelView/nivel_4': 'nivel_4',
    '/levelView/nivel_5': 'nivel_5',
  };
  return map[path];
}
...
final appRouter = GoRouter(
  ...
  routes: [
    ...
    GoRoute(
      path: '/levelView/nivel_3',
      builder: (context, state) => const LevelScreen(level: Levels.level3),
    ),
    GoRoute(
      path: '/levelView/nivel_4',
      builder: (context, state) => const LevelScreen(level: Levels.level4),
    ),
    GoRoute(
      path: '/levelView/nivel_5',
      builder: (context, state) => const LevelScreen(level: Levels.level5),
    ),
  ],
);
